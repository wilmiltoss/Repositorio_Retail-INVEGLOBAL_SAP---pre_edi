...
Public Class LocacionesSQLiteADM
    Inherits ADMbase

#Region "ATRIBUTOS"

    Public Const NOMBRE_CLASE As String = "LocacionesSQLiteADM"
...
#Region "CONSTRUCTORES"
    ...
    Public Sub New(ByVal ApModeloParam As ApModeloSQLite)
        ...
        Set_tabla(New LocacionesSQLiteTBL())
...
#Region "Miembros de ADMbase"
    ...
    Public Overrides Function lAgregar(ByVal oLocacionParam As OTDbase) As List(Of Object)
        ...
        Try
            ...
            Dim oLocacion As LocacionSQLiteOTD = CType(oLocacionParam, LocacionSQLiteOTD)
    ...
    Public Overrides Function lEliminar(ByVal oLocacionParam As OTDbase) As List(Of Object)
...
#Region "ESPECIFICOS"
    ...
    Public Function lCrear_tabla() As List(Of Object)
        ...
        Try
            ...
            lResultado = _oConector.lEjecutar_sentencia(LocacionesSQLiteTBL.SQL_DROP_TABLA)

            'si se ejecuto correctamente, creamos de vuelta la tabla
            If lResultado(0).Equals(1) Then lResultado = _oConector.lEjecutar_sentencia(LocacionesSQLiteTBL.SQL_CREAR_TABLA)
